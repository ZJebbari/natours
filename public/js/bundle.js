...
/* eslint-disable */
var displayMap = exports.displayMap = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(locations) {
    var map, bounds, getPlaceName, _iterator, _step, loc, placeName, el;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          bounds = new mapboxgl.LngLatBounds(); // Function to fetch place name using coordinates
          getPlaceName = /*#__PURE__*/function () {
            var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(coordinates) {
              var _coordinates, lng, lat, url, _data$features$, response, data;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    _coordinates = _slicedToArray(coordinates, 2), lng = _coordinates[0], lat = _coordinates[1];
                    url = "https://api.mapbox.com/geocoding/v5/mapbox.places/".concat(lng, ",").concat(lat, ".json?access_token=").concat(mapboxgl.accessToken);
                    _context.prev = 2;
                    _context.next = 5;
                    return fetch(url);
                  case 5:
                  ...
                  case 8:
                    data = _context.sent;
                    return _context.abrupt("return", ((_data$features$ = data.features[0]) === null || _data$features$ === void 0 ? void 0 : _data$features$.place_name) || 'Unknown location');
                  case 12:
                    _context.prev = 12;
                    _context.t0 = _context["catch"](2);
                    console.error('Geocoding error:', _context.t0);
                    return _context.abrupt("return", 'Unknown location');
                  case 16:
                  case "end":
            ...
            return function getPlaceName(_x2) {
              return _ref2.apply(this, arguments);
            };
          }(); // Loop through each location
          _iterator = _createForOfIteratorHelper(locations);
          _context2.prev = 5;
          _iterator.s();
        case 7:
          ...
          loc = _step.value;
          _context2.t0 = loc.description;
          if (_context2.t0) {
            _context2.next = 14;
            break;
          }
          _context2.next = 13;
          return getPlaceName(loc.coordinates);
        case 13:
          _context2.t0 = _context2.sent;
        case 14:
          placeName = _context2.t0;
          ...
          new mapboxgl.Popup({
            offset: 30
          }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day || '', ": ").concat(placeName, "</p>")).addTo(map);
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51QVnGeBq9y78bRCfSBRLkdopB7I6tldIVFaNa4I1eAwQaPjauJn4rSZY7pPnDP1g8xuo7yeetfNlRtfaMJlFaKMp00t2CxCBOt');
          _context.prev = 1;
          _context.next = 4;
